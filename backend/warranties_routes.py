    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            cur.execute('''
                ...
                GROUP BY w.id, u.id
                ORDER BY COALESCE(u.username, 'zzz_deleted_user'), CASE WHEN w.is_lifetime THEN 1 ELSE 0 END, w.expiration_date NULLS LAST, w.product_name
            ''')
            ...
            for row in warranties:
                ...
                if first_name and last_name:
                    ...
                    warranty_dict['user_display_name'] = 'Deleted User'
