...
# IMPORTANT:
# `preload_app=True` initializes Flask app (and side effects like scheduler/pools)
# in the master process before forking workers. In this project that causes
# duplicated scheduler behavior and stale DB pool PID warnings in workers,
# leading to intermittent 500/503 and white pages. Keep it disabled.
preload_app = False
